				...
				<nav class="navbar navbar-default" style="background-color: #fff;">
					<div class="container-fluid">
						<div class="navbar-header" >
							...
							<a class="navbar-brand" href="#">KOSTUM</a>
						</div>
								...
								<!-- <div class="box-body table-responsive"> -->
									<table  class="table table-bordered table-striped">
										...
										<tbody>
											<?php
											include("../koneksi.php");
											$tampil = "SELECT id_kostum,nama_kategori,nama,gambar,harga,stok,deskripsi FROM kostum INNER JOIN kategori ON kostum.id_kategori=kategori.id_kategori ORDER BY id_kostum DESC";
											...
											<tr style=\"font-size:11px;\">
															...
															<td align=\"center\">
																	<a href=\"#\" class=\"btn btn-primary open_modal btnku
																		\" id=$data[id_kostum] ><span class=\"glyphicon glyphicon-pencil\"></span></a>&nbsp;
																		<a href=\"hapus_produk.php?id=$data[id_kostum]\" onclick=\"return confirm('Yakin Ingin Menghapus Data ?')\"class=\"btn btn-danger btnku\"><span class=\"glyphicon glyphicon-trash\"></span></a>
																	</td>
															</tr>
															";
												}  ?>
						...
						<footer class="footer" style="background-color: #000;">
							<div class="container-fluid">
								...
								<div class="copyright pull-right">
									&copy; <script>document.write(new Date().getFullYear())</script>, made with <i class="glyphicon glyphicon-heart"></i> by <a href="http://www.GoKostum.com">GoKostum Team</a>
								</div>
							</div>
						</footer>
						<!-- Modal Tambah-->
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									$tampil = "SELECT max(id_kostum) FROM kostum";
									...
									<form action="input_produk.php" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
												<input type="text" name="id_kostum" class="form-control" value="<?php echo $hasilkode ?>" readonly>
											</div>
											<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
